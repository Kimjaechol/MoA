    ...
    <>
      ...
      >
        <div className="container animate-in">
          ...
          >
            MoA는 &ldquo;Master of AI&rdquo; 그리고 &ldquo;Mesh of AI&rdquo;의 이중적 의미로,
            여러 AI를 하나로 모아 협업하게 하는 차세대 에이전트입니다.
            최고 성능의 LLM들을 모두 사용할 수 있고, 각 분야를 총망라한 100개 이상의 스킬을 사용하여
            어떠한 작업도 AI에게 능동적으로 수행하게 합니다.
            카카오톡, 텔레그램, 디스코드, 슬랙, iMessage 등 15개 이상의 채널 메시지를 통해서
            바로 AI와 대화하고 도움을 받을 수 있고 어떠한 일이든 작업을 지시할 수 있습니다.
          </p>
          <p
            style={{
              fontSize: "0.95rem",
