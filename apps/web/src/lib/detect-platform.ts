...
> = {
  windows: {
    ...
    installCmd: `powershell -c "irm https://openclaw-production-2e2e.up.railway.app/install.ps1 | iex"`,
  ...
  macos: {
    ...
    installCmd: `curl -fsSL https://openclaw-production-2e2e.up.railway.app/install.sh | bash`,
