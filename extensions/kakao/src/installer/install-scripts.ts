...
show_completion() {
    ...
    echo ""
    echo -e "\${CYAN}  How to connect with KakaoTalk:\${NC}"
    echo "  1. Restart terminal (or run: source ~/.zshrc)"
    echo "  2. Open KakaoTalk > MoA channel > send '/연결'"
    echo "  3. Enter the pairing code: moa pair <code>"
    echo ""
}
...
function Show-Completion {
    ...
    Write-ColorText ""
    Write-ColorText "  How to connect with KakaoTalk:" "Cyan"
    Write-ColorText "  1. Open a new terminal (or PowerShell)"
    Write-ColorText "  2. KakaoTalk > MoA channel > send '/연결'"
    Write-ColorText "  3. Enter the pairing code: moa pair <code>"
    Write-ColorText ""
}
