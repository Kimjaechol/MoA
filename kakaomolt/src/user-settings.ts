...
export const PROVIDERS: Record<LLMProvider, ProviderInfo> = {
  anthropic: {
    ...
    models: [
      ...
      { id: "claude-opus-4-6", name: "Claude Opus 4.6", provider: "anthropic", inputPrice: 7250, outputPrice: 36250, contextWindow: 1000000 },
    ],
  },
  openai: {
    id: "openai",
 ...
 * - Claude Opus 4.6: 최고 성능, 고가 (입력 7,250원/1M)
 */
